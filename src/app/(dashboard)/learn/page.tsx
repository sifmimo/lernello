...
import { BookOpen, Calculator, Globe, Palette, Music, FlaskConical, ChevronRight, User, LogOut, Trophy, Star, Flame } from 'lucide-react';
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-gray-900">
                      {subjectNames[subject.code] || subject.name_key}
                    </h3>
