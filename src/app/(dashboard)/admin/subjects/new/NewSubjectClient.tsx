...
const schoolLevels = [
  { code: 'maternelle', name: 'Maternelle' },
  { code: 'cp', name: 'CP (6 ans)' },
  { code: 'ce1', name: 'CE1 (7 ans)' },
  { code: 'ce2', name: 'CE2 (8 ans)' },
  { code: 'cm1', name: 'CM1 (9 ans)' },
  { code: 'cm2', name: 'CM2 (10 ans)' },
  { code: 'primaire', name: 'Primaire (tous niveaux)' },
];
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Si la matière n'existe pas dans le programme officiel, elle sera adaptée à ce niveau
                </p>
              </div>
